...
dense_detocc
ggsave("./Deliverables/HabChap_ModelVisualizations/DensityPlot_DetSubmod_7-10.jpg", width=8, height=6)
...
ggsave("./Deliverables/HabChap_ModelVisualizations/DensityPredEffectsPlot_PointScale_7-10.jpg", width=12, height=8)

# Core scale
dense_coreocc / free(pe_vegcom | pe_sesheight | pe_canheight | pe_sescore)
ggsave("./Deliverables/HabChap_ModelVisualizations/DensityPredEffectsPlot_CoreScale_7-10.jpg", width=12, height=8)

# Landscape scale
dense_lanscocc / free(pe_canlandsc | pe_seslandsc)
ggsave("./Deliverables/HabChap_ModelVisualizations/DensityPredEffectsPlot_LandscScale_7-10.jpg", width=12, height=8)

# Linear model 
dense_lm
ggsave("./Deliverables/HabChap_ModelVisualizations/DensityPlot_LinearMod_7-10.jpg", width=8, height=6)
...
ggsave("./Deliverables/HabChap_ModelVisualizations/PredEffectsPlot_LinearMod_7-10.jpg", width=8, height=6)
