...
aru_table <- readRDS("./Data/Detection_History/2022_All_ARUs/Outputs/2022_DeployPeriodTable_CorrectedEffort_ClipMaskedFinalRec_8-14.RData")
# create site column
...
# write this to csv
#write.csv(pos_aru, "./Data/Detection_History/2022_All_ARUs/Outputs/2022_SiteswBBCU_DayswCalling_8-15.csv", row.names = FALSE)
