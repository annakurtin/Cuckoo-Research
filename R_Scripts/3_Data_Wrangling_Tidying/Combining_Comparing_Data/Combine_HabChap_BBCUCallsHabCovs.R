...
habcovs_22 <- read.csv("./Data/Habitat_Model_Covariates/Occupancy_Covariates/All_2022Veg_Covariates_8-15.csv")
habcovs_23 <- read.csv("./Data/Habitat_Model_Covariates/Occupancy_Covariates/All_2023Veg_Covariates_8-12.csv") %>% select(-grts_grouped)
...
dat1 <- lm_dat[,1:12]
dat2 <- round(scale(lm_dat[,13:23]),2)
all_scaled <- cbind(dat1,dat2)

# Export for use in linear model 
#write.csv(all_scaled, "./Data/Habitat_Model_Covariates/Linear_Model/HabChap_22-23_DaysCalls_HabCovs.csv", row.names = FALSE)
