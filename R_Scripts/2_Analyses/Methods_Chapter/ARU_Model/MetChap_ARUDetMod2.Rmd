...
naive_aru <- (sum(comp_dat$bbcu_aru)/nrow(comp_dat)) * 100
naive_pb <- (sum(comp_dat$bbcu_pb)/nrow(comp_dat)) * 100
```

Thoughts: 

Vegetation density changed the f statistic. 
...
Also, the playback esitmates of detection probability seem a bit high. 