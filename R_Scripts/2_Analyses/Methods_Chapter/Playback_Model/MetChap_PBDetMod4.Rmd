...
I'm going to try to remove the state submodel and only focus on the detection process. Last model had a very poor p value so I'm going to try to remove the quadratic effect of date and see if this performs better.
