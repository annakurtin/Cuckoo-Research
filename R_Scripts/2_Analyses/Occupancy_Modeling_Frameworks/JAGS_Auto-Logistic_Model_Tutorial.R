#### Auto-Logistic Occupancy Model Tutorial ####
...
", file = "./R_Scripts/2_Analyses/Occupancy_Modeling_Frameworks/Models/Auto-Log_Mod1.txt")
...
my_mod <- runjags::run.jags(
  model.file = "R_Scripts/2_Analyses/Occupancy_Modeling_Frameworks/Models/Auto_Log_Mod1.txt",
...
# Still getting error - object 'NA' not found ??????????????????????????/
