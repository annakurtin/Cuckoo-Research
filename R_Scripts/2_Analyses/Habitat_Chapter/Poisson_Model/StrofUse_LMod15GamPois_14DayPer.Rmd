...
b6 <- round(plogis(fit_gpois$q50$beta0 + fit_gpois$q50$beta5), 3)
print(paste0("Recording Days at Site: ", b6))

b7 <- round(plogis(fit_gpois$q50$beta0 + fit_gpois$q50$beta6), 3)
print(paste0("Background Noise at Site: ", b7))

b8 <- round(plogis(fit_gpois$q50$beta0 + fit_gpois$q50$beta7), 3)
