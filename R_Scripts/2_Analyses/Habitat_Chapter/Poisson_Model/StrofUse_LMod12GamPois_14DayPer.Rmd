...
* How do we interpret the posterior estimates? 

* What does posterior intercept of -1.71 mean? plogis this gives us 0.15. How can this be the number of calls?

* Do I need to scale my response variable as well? 
