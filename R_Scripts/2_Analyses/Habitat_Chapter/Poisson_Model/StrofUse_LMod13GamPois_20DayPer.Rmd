---
title: "Hab Chap Linear Model Version 13: Gamma-Poisson Paramterization on 20 Day Period During Peak Calling"
author: "Anna Kurtin"
date: "9/26/2024"
output: html_document
---

This is the thirteenth iteration of the linear model I will be using to test strength of habitat use across sites. Using the gamma-poisson distribution to parameterize the response variable to account for not only how many days with calling but also how many days there are for each site. Trying to include all of the data including the zeros and all of the covariates of interest. Only looking at data from the period between June 25th and July 15th so that standardizing effort, adding in covariate for the number of days recorded at a site.

Not going with this version of the model, instead using the 14 day period since it preserves more data
...
```{R Read in Data}
full_dat <- read.csv("C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/Data/Habitat_Model_Covariates/Linear_Model/DaysCalls_20DayPer_HabCovsSCALED_22-23_9-26.csv")
```
...
sink("C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/R_Scripts/2_Analyses/Habitat_Chapter/Poisson_Model/Model_Structure_Files/JAGS_HabLMod13_GamPois.jags")
cat("
    model {
    for (i in 1:n){
...
fit_gpois <- jags(data = jags_data, 
                 model.file = "C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/R_Scripts/2_Analyses/Habitat_Chapter/Poisson_Model/Model_Structure_Files/JAGS_HabLMod13_GamPois.jags",
                 ...
                 inits = init_func)
beep()
saveRDS(fit_gpois,"C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/R_Scripts/2_Analyses/Habitat_Chapter/Poisson_Model/Models_Ran_Outputs/LMod13_GamPois_20Day.Rdata")
```
```{R Read in Model}
fit_gpois <- readRDS("C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/R_Scripts/2_Analyses/Habitat_Chapter/Poisson_Model/Models_Ran_Outputs/LMod13_GamPois_20Day.Rdata")
```
