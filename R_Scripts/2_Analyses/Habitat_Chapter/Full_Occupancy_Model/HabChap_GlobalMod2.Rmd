...
* cova7: dominant floodplain community
...
* What about coefficients that aren't significant anymore (% subcanopy core and subcanopy average height)? Should we leave these out and make another version of the global model?

* The Bayesian p value (indicating model fit) isn't close to .5, indicating that there is an issue with the model. How can I troubleshoot this, or where in the model do we think the issues are originating from?
