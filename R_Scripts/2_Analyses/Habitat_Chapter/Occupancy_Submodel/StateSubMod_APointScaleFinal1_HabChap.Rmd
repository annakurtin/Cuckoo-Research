...
* Point Submodel 1: Deciduous tree species richness, broadleaf, invasive, upland, floodplain shrub community. 

* Point Submodel 2: Deciduous tree species richness, floodplain shrub community

* Point Submodel 3: Deciduous tree species richness, floodplain shrub community, conifer tree species richness
...
ggplot(data = chains_viol_long, aes(x = values, y = parameter, fill = parameter)) + 
  ...
  geom_text(data = f_stat, aes(x = 3.5, y = parameter, label = median_value), color = "black", hjust = .6)  # Adjust hjust to position the text
```
