...
f_stat <- data.frame(
  parameter = c("% Subcanopy Cover","Canopy Height", "Subcanopy Height", "Veg SD Resid"),
  median_value = c(round(fit_CF1$f$a1,2), round(fit_CF1$f$a2,2),round(fit_CF1$f$a3,2), round(fit_CF1$f$a4,2))
)
