...
$$ \alpha_1: \text{% open shrubby cover core area}$$
...
oshrubcov_p2 <- ggplot(oshrubcov) + 
  geom_jitter(aes(x = pct_openshrub_core, y = bbcu), color = palette_8[2], width = .05, height = .05) +
  geom_smooth(aes(x = pct_openshrub_core, y = bbcu), color = palette_8[2], se = FALSE, method = "glm", method.args = list(family = "binomial")) +
  scale_y_continuous(breaks = seq(0, 1, by = 1)) +
  labs(x = "% Open Shrub Cover", y = "Detection") + theme_minimal()
```
...
cat("
  ...
  ", file = "C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/R_Scripts/2_Analyses/Habitat_Chapter/Occupancy_Submodel/Model_Structure_Files/JAGS_HabOccMod_CFin2.txt")
...
fit_CF2 <- jags(data = jags_data, 
                 ...
                 inits = init_func)
beep()
saveRDS(fit_CF2,"C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research/R_Scripts/2_Analyses/Habitat_Chapter/Occupancy_Submodel/Models_Ran_Outputs/StateSubModel_CFinal2.Rdata")
```
...
colnames(chains_viol) <- c("% Open Shrub Cover","Canopy Height", "Subcanopy Height", "Veg SD Resid")
# Pivot this longer so that we can visualize it
chains_viol_long <- chains_viol %>% pivot_longer(cols = c("% Open Shrub Cover","Canopy Height", "Subcanopy Height", "Veg SD Resid"),names_to = "parameter", values_to = "values")

f_stat <- data.frame(
  parameter = c("% Open Shrub Cover",
                "Canopy Height", 
                "Subcanopy Height", 
                "Veg SD Resid"),
...
ggplot(data = chains_viol_long, aes(x = values, y = parameter, fill = parameter)) + 
  ...
  stat_slabinterval() +
  # Establish colors
  scale_fill_manual(values = c("% Open Shrub Cover"=palette_8[2], "Canopy Height" = palette_8[3], "Subcanopy Height" = palette_8[4], "Veg SD Resid" = palette_8[7])) +
...
print(paste0("% Open Shrub Cover Core: ", a1))
