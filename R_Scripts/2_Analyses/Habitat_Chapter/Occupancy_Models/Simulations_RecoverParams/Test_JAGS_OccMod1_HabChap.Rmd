---
title: "Habitat Chapter JAGS Occupancy Sub Model 1 Recover Parameters on Simulated Data"
author: "Anna Kurtin"
date: "7/3/2024"
output: html_document
---

This is the occupancy submodel with properly specified logistic priors, all eight covariates, and a random effect for shrub community (a categorical variable). 

**Model structure:**

Full state model:
$$
z_i \sim Bernoulli(\psi | \beta_{tree richness}, \beta_{shrub comminity}, \beta_{subcan height}, \beta_{subcancover}, \beta_{subcan complexity}, \beta_{veg density}, \beta_{canopy height}, \beta_{canopycover})
$$
