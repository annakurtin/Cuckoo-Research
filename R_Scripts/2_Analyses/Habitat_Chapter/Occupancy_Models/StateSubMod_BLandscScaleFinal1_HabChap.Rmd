...
I'll be using the same structure in this model, adding in the newly cleaned data and the new detection model with veg density as a covariate. 
...
f_stat <- data.frame(
  parameter = c("% Canopy Cover",
                "% Subcanopy Cover"),
  median_value = c(paste0("F: ",round(fit_BF1$f$a1,2)),
                   paste0("F: ",round(fit_BF1$f$a2,2)))
)
