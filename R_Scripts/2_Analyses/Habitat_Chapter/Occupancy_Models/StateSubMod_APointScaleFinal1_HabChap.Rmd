...
```{R Check Parameter Correlations, out.width ="100%"}
...
# plot(fit_AF1$sims.list$a0,fit_AF1$sims.list$a1)
# plot(fit_AF1$sims.list$a0,fit_AF1$sims.list$a2)
# plot(fit_AF1$sims.list$a0,fit_AF1$sims.list$a3)
# plot(fit_AF1$sims.list$a0,fit_AF1$sims.list$a4)
