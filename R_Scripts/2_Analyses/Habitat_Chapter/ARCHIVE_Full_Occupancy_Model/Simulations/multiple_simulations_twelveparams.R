...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# This is the script with more parameters than should be reasonable:
## The number of sites that we have for our study 
## Twelve parameters in total: psi, p, a1-5, b1-5
## Five covariates on detection, five covariates on occupancy 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
library(tidyverse)
library(jagsUI)
...
title(main = "Residuals for alpha 1, 12 params")

# Look at the difference in estimates of psi and p
...
title(main = "Latent State Estimations, 12 params")
...
ggplot() +
  ...
  labs(title = "Difference in lod odds estimate per simulation, 12 params") +
  theme_minimal()
...
ggplot() +
  ...
  geom_hline(yintercept=0) +
  labs(title = "Difference in probability estimate per simulation, 12 params") +
  theme_minimal()
