...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# This is the script with the smallest amount of parameters:
## The number of sites that we have for our study 
## Four parameters in total: psi, p, a1, b1
...
title(main = "Residuals for alpha 1, 4 params")
...
title(main = "Latent State Estimations, 4 params")
...
colnames(diffs) <- c("sim_num","a1","b1")
...
ggplot() +
  ...
  labs(title = "Difference in lod odds estimate per simulation, 4 params") +
  theme_minimal()
...
ggplot() +
  ...
  geom_hline(yintercept=0) +
  labs(title = "Difference in probability estimate per simulation, 4 params") +
  theme_minimal()
