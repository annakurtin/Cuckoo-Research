...
f_stat <- data.frame(
  parameter = c("veg density","background noise","effort","date", "quadratic date"),
  median_value = c(round(habdet_f2$f$b1,2), round(habdet_f2$f$b2,2), round(habdet_f2$f$b3,2), round(habdet_f2$f$b4,2), round(habdet_f2$f$b4Q,2))
)
