---
title: "JAGS Detection Model For Habitat Chapter V1"
author: "Anna Kurtin"
date: "5/20/2024"
...
To add: test to see if you can recover simulated variables from your jags model 
**ADD IN HERE LATER**


```{r Run JAGS Model 1, eval = FALSE}
# b1/cov1: date
# b2/cov2: veg density
...
jags_fit_global <- readRDS("C:/Users/annak/OneDrive/Documents/UM/Research/Coding_Workspace/Cuckoo-Research//R_Scripts/7_Model_Scripts/JAGS_Global_Detection_Model.Rdata")
...
jags_fit_global_1rem <- jags(data = jags_data_1rem, 
                 ...
                 n.chains = 3,
                 inits = init_func)
saveRDS(jags_fit_global_1rem, file = "./R_Scripts/7_Model_Scripts/JAGS_Global_Detection_Model_LastSurveyRemoved.Rdata")
...
jags_fit_global_1rem2 <- jags(data = jags_data_1rem, 
                 ...
                 n.chains = 3,
                 inits = init_func)
saveRDS(jags_fit_global_1rem2, file = "./R_Scripts/7_Model_Scripts/JAGS_Global_Detection_Model_LastSurveyRemoved_2xIter.Rdata")
tracedens_jags(jags_fit_global_1rem2)
summary(jags_fit_global_1rem2)
```
More iterations: didn't help, model looks maybe closer to converging but isn't there. I think I need to specify better initial values. 
