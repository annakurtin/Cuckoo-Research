...
$$
logit(p_{ij}) = \beta_0 + \beta_1*\text{vegetation density}_i + \beta_2 * \text{background noise}_i + \beta_3 * \text{survey effort}_{ij} + \beta_4 * \text{Julian date}_{ij} + \beta_5 * \text{Julian date}^2_{ij} + \beta_6 * \text{ARU type}_i
$$
...
b1 <- round(plogis(habdet$q50$b0 + habdet$q50$b1), 3)
print(paste0("veg density:", b1))

b2 <- round(plogis(habdet$q50$b0 + habdet$q50$b2), 3)
print(paste0("background noise:", b2))

b3 <- round(plogis(habdet$q50$b0 + habdet$q50$b3), 3)
print(paste0("survey effort:", b3))

b4 <- round(plogis(habdet$q50$b0 + habdet$q50$b4), 3)
print(paste0("date:", b4))

b4Q <- round(plogis(habdet$q50$b0 + habdet$q50$b4Q), 3)
print(paste0("quadratic effect of date:", b4Q))

b5 <- round(plogis(habdet$q50$b0 + habdet$q50$b5), 3)
